    ...
    <div class="music">
      <div v-show="allTracks.length>0" style="width: 100%">
        ...
        >
          ...
          <vxe-table-column title="音乐标题" :show-overflow-tooltip="true">
            <template slot-scope="scope">
              <div>
                <i v-show="music.id == scope.row.id " class="play-now ifont icon-laba"></i>
                {{scope.row.title||scope.row.fileName}}
              </div>
            </template>
          </vxe-table-column>
          <vxe-table-column field="artist" title="歌手" width="200" :show-overflow-tooltip="true"></vxe-table-column>
          <vxe-table-column field="album" title="专辑" :show-overflow-tooltip="true"></vxe-table-column>
          <vxe-table-column field="filePath" title="路径" :show-overflow-tooltip="true"></vxe-table-column>
          <vxe-table-column title="图片" width="50" :show-overflow-tooltip="true">
            <template slot-scope="scope">
              <img
                v-if="false"
      ...
      <div v-if="allTracks.length==0" class="empty-tmp">
        ...
        <div class="slogan">爱我所爱&nbsp;&nbsp;&nbsp;&nbsp;听你想听</div>
        <div>
